            ...
            .map((race, i) => {
              ...
              return (
                <tr
                  key={i}
                  onClick={() => {
                    navigate(`/crowsnest/rankings/regatta/${race.raceID}/${race.pos}`)
                  }}
                  className='clickable'>
                  ...
                  <td className='tableColFit' onClick={() => navigate(`/crowsnest/rankings/${race.partner}`)}>
                    <Link to={`/crowsnest/rankings/${race.partner}`}>{race.partner}</Link>
                  </td>
